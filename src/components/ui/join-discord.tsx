...
const JoinDiscordButton: React.FC<JoinDiscordButtonProps> = ({ inviteLink }) => {
  ...
  return (
    <>
      ...
      <Link href={inviteLink}>
        <div className="inline-flex items-center justify-center whitespace-nowrap font-medium focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 m-0 p-1 transition-all duration-300 ease-in-out hover:bg-accent hover:text-accent-foreground size-9 rounded-full text-sm">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 127.14 96.36"
            className="h-4 bg-transparent md:hidden"
            fill="currentColor"
            aria-hidden="true"
          >
          <path
